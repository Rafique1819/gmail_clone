    ...
    return (
        <div className='w-[15%]'>
            <div className='p-3'>
                ...
                <button onClick={()=>dispatch(setOpen(true))} className='flex item-center gap-2 p-4 rounded-2xl hover:shadow-md bg-[#C2E7FF]'>  <LuPencil size={"24px"} className='mt-1' /> Compose</button>
            </div>
