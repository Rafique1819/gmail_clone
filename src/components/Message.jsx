    ...
    return (
        <div onClick={OpenMail} className='flex items-start justify-between border-b border-gray-200 px-4 p-2 text-sm hover:cursor-pointer hover:shadow-md'>
            ...
            <div className='flex-1 ml-4'>
                <p className='text-gray-600 truncate inline-block max-w-full'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quasi saepe sequi voluptatem.</p>
            </div>
